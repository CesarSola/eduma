...
Route::middleware(['auth', 'role:Admin'])->group(function () {
    Route::get('/usuariosAdmin', [AdminController::class, 'index'])->name('usuariosAdmin');
    Route::get('/cursos', [CoursesController::class, 'index'])->name('cursos');
    Route::get('/competenciasAD', [CompetenciasController::class, 'index'])->name('competenciasAD');
    Route::get('/documentosnec', [DocumentsController::class, 'index'])->name('documentosnec');
    Route::get('/codigos-postales', [PostalCodesController::class, 'index'])->name('codigos-postales');
});
