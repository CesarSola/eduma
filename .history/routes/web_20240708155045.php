...
Route::get('/form/download', 'FormController@downloadForm')->name('form.download');
Route::get('/form/download-empty', 'FormController@downloadEmptyForm')->name('form.download.empty');
