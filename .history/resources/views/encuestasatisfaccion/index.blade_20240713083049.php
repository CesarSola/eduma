        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @foreach(range(1, 8) as $index)
                ...
                if (selectedEmoji) {
                    ...
                    var emojiElement = document.querySelector('#question{{ $index }} .emoji');
                    if (emojiElement && emojiElement.innerHTML.trim() === selectedEmoji) {
                        emojiElement.style.border = '1px solid blue';
                    }
                }
            @endforeach
        });
