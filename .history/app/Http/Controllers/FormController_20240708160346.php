...
use App\Models\SurveyResponse; // Importa el modelo SurveyResponse
...
class FormController extends Controller
{
    ...
    public function submitForm(Request $request)
    {
        ...
        $surveyResponse->name = $request->input('name');
        $surveyResponse->question1 = $request->input('question1');
        $surveyResponse->question2 = $request->input('question2');
        $surveyResponse->question3 = $request->input('question3');
        $surveyResponse->question4 = $request->input('question4');
        $surveyResponse->question5 = $request->input('question5');
        $surveyResponse->question6 = $request->input('question6');
        $surveyResponse->question7 = $request->input('question7');
        $surveyResponse->question8 = $request->input('question8');
        $surveyResponse->doubts = $request->input('doubts');
        $surveyResponse->save();
        ...
        // Datos del formulario en el documento
