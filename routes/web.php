...
Route::get('validarCoP/show/{id}', [ValidarCoPController::class, 'show'])->name('validarCoP.show');
Route::get('validarCuP/show/{id}', [ValidarCuPController::class, 'show'])->name('validarCuP.show');
