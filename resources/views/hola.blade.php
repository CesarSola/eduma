                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-center align-items-center">
                                    <button type="button" class=""
                                        style="background-color: blue; color: white; border-radius: 5px; width: 300px; height: 40px; border-color: transparent;">{{ __('Siguiente Paso') }}</button>
                ...
                <div id="step-2" style="display:none;">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" id="codigo_postal" name="codigo_postal"
                            ...
                            placeholder="{{ __('Código Postal') }}" value="{{ old('codigo_postal') }}" required>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.codigosPostales) {
                            ...
                            // Ocultar campos que tengan valores null
                            if (primerLugar.d_asenta === null) {
                                coloniaSelect.parent().hide();
                            }
                            if (primerLugar.D_mnpio === null) {
                                municipioSelect.parent().hide();
                            }
                            if (primerLugar.d_estado === null) {
                                estadoSelect.parent().hide();
                            }
                            if (primerLugar.d_ciudad === null) {
                                ciudadSelect.parent().hide();
                            }
