        ...
        <form id="register-form" action="{{ route('register') }}" method="post">
            ...
            <div id="step-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="{{ __('Primer nombre') }}" value="{{ old('name') }}" required autofocus>
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" name="secondName" class="form-control @error('secondName') is-invalid @enderror" placeholder="{{ __('Segundo nombre') }}" value="{{ old('secondName') }}" required>
                            @error('secondName')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" name="paternalSurname" class="form-control @error('paternalSurname') is-invalid @enderror" placeholder="{{ __('Apellido paterno') }}" value="{{ old('paternalSurname') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" name="maternalSurname" class="form-control @error('maternalSurname') is-invalid @enderror" placeholder="{{ __('Apellido materno') }}" value="{{ old('maternalSurname') }}" required>
