<section>
    ...
    <form action="{{ route('cursos.update', $curso->id) }}" method="POST">
        ...
        <div class="form-group">
            <label for="documentosnec_id">Documentos</label>
            @foreach ($documentosnec as $estandar)
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="documentosnec_id[]"
                        ...
                        {{ in_array($estandar->id, $curso->documentosnec->pluck('id')->toArray()) ? 'checked' : '' }}>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control" id="modalidad" name="modalidad">
                    ...
                    <option value="Presencial" {{ $curso->modalidad == 'Presencial' ? 'selected' : '' }}>Presencial
                    </option>
