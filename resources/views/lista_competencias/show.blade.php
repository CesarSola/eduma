    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <ul class="list-disc list-inside bg-white p-4 rounded-lg shadow-md dark:bg-gray-800">
            <li class="mb-2 text-gray-900 dark:text-white">
                <a href="URL_TO_PDF" class="text-blue-500 hover:underline dark:text-blue-300">CARTA DE AUTORIZACIÓN DE FIRMA DIGITAL PDF</a>
            </li>
            <li class="mb-2 text-gray-900 dark:text-white">
                <a href="URL_TO_PDF" class="text-blue-500 hover:underline dark:text-blue-300">Derechos y obligaciones PDF</a>
            </li>
            ...
            <li class="mb-2 text-gray-900 dark:text-white">4. Instrumentos de evaluación: cuestionario, lista de cotejo y guías de obervación</li>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden dark:bg-gray-800 p-2 mb-4">
                ...
                <!-- Botón de descarga -->
                <a href="" download="{{ $documento->documentos }}" class="block w-full text-center py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out">
                    Descargar
                </a>
            </div>
            @endforeach
