...
<div class="overflow-x-auto">
    <table id="competenciasTable" class="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-300 dark:border-gray-700">
                ...
                <td class="py-2 px-4 text-gray-700 dark:text-gray-300">
                    @foreach ($competencia->documentosnec as $documento)
                        <a href="{{ Storage::url($documento->documentos) }}" class="block hover:text-blue-600" download>{{ $documento->name }}</a>
                    @endforeach
                </td>
                <td class="py-2 px-4 text-gray-700 dark:text-gray-300">
                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal{{ $competencia->id }}">
            ...
            <div class="modal fade" id="editModal{{ $competencia->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $competencia->id }}" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel{{ $competencia->id }}">Editar competencias</h5>
