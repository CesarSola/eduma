    ...
    <table id="cursos-table" class="table table-bordered table-hover ">
        ...
        <tbody>
            @foreach ($documentosnec as $documentosnec)
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                            data-target="#editModal{{ $documentosnec->id }}">
                ...
                <div class="modal fade" id="editModal{{ $documentosnec->id }}" tabindex="-1"
                    aria-labelledby="editModalLabel{{ $documentosnec->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel{{ $documentosnec->id }}">Editar documentos
                                    nececesarios</h5>
