                ...
                <form method="POST" action="{{ route('usuarios.update', $users->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            value="{{ $users->name }}" placeholder="Nombre">
                    </div>
                    <div class="mb-3">
                        <label for="secondName" class="form-label">Segundo Nombre:</label>
                        <input type="text" class="form-control" id="secondName" name="secondName"
                            value="{{ $users->secondName }}" placeholder="Segundo Nombre">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="paternalSurname" name="paternalSurname"
                            value="{{ $users->paternalSurname }}" placeholder="Apellido Paterno">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="maternalSurname" name="maternalSurname"
                            value="{{ $users->maternalSurname }}" placeholder="Apellido Materno">
                    </div>
                    <div class="mb-3">
                        <label for="age" class="form-label">Edad:</label>
                        <input type="number" class="form-control" id="age" name="age"
                            value="{{ $users->age }}" placeholder="Edad">
                    </div>
            </div>
