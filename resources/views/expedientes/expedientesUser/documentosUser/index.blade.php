                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="ine_ife" accept="application/pdf" required
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="comprobante_domiciliario"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="curp" accept="application/pdf" required
