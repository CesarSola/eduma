            ...
            <div class="flex-container">
                ...
                <div class="Div-1">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="calle_avenida" name="calle_avenida" type="text" class="mt-1 block w-full" :value="old('calle_avenida', $user->calle_avenida)" required autofocus autocomplete="calle_avenida" />
                ...
                <div class="Div-2">
                    ...
                    <div class="mb-4">
                            ...
                            <x-text-input id="secondName" name="secondName" type="text" class="mt-1 block w-full" :value="old('secondName', $user->secondName)" required autofocus autocomplete="secondName" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="numext" name="numext" type="text" class="mt-1 block w-full" :value="old('numext', $user->numext)" required autofocus autocomplete="numext" />
                ...
                <div class="Div-3">
                    ...
                    <x-text-input id="paternalSurname" name="paternalSurname" type="text" class="mt-1 block w-full" :value="old('paternalSurname', $user->paternalSurname)" required autofocus autocomplete="paternalSurname" />
                ...
                <div class="Div-4">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="maternalSurname" name="maternalSurname" type="text" class="mt-1 block w-full" :value="old('maternalSurname', $user->maternalSurname)" required autofocus autocomplete="maternalSurname" />
